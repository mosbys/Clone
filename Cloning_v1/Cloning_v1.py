...
def generate_next_batch(batch_size=16):
    ...
    while True:
        ...
        X_batch = np.zeros([batch_size,160,80,ImgShape[2]])
        ...
        for i in range(iIndex,iIndex+batch_size):
            ...
            X_batch[i-iIndex] = cv2.resize(tmpImg,(160, 80), interpolation = cv2.INTER_CUBIC)
...
model.add(Lambda(lambda x: x/255.-0.5,input_shape=(160, 80, 3)))

model.add(Convolution2D(24, 5, 5, border_mode='same', input_shape=(160, 80, 3)))
